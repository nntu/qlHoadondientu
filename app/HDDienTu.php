...
{
    protected $fillable = ['MST',   'kyhieu', 'sohoadon', 'sotien', 'matracuu', 'diachitracuu', 'ngayhoadon', 'nguoithanhtoan', 'ngaythanhtoan'];
    protected $table = 'hddientu';

    public function ds_HoaDon($ngaydau, $ngaycuoi, $mst)
    {
        \Log::info([$mst]);
        $resules = $this->select('hddientu.id', 'hddientu.MST', 'TenDonVi',   'kyhieu', 'sohoadon', 'sotien', 'matracuu', 'diachitracuu', 'ngayhoadon', 'nguoithanhtoan', 'ngaythanhtoan')
